...
```{r EXPORT TABLES}
write.csv2(tab1, file = "~/Dropbox/Data IMED/Analisis IMED/output/tabs_prestaciones/VIH/caida prestaciones.csv", 
           sep = ";", dec = ".")
write.csv2(tab2, file = "~/Dropbox/Data IMED/Analisis IMED/output/tabs_prestaciones/VIH/caida prestaciones por sexo.csv", 
           sep = ";", dec = ".")
write.csv2(tab3, file = "~/Dropbox/Data IMED/ANID-Covid/Analisis IMED/output/tabs_prestaciones/VIH/caida prestaciones por prevision.csv", 
           sep = ";", dec = ".")
write.csv2(tab4, file = "~/Dropbox/Data IMED/Analisis IMED/output/tabs_prestaciones/VIH/caida prestaciones por edad.csv", 
           sep = ";", dec = ".")
write.csv2(tab5, file = "~/Dropbox/Analisis IMED/output/tabs_prestaciones/VIH/caida prestaciones por región.csv", 
           sep = ";", dec = ".")
```
